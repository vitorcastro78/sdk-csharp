...
namespace Zuora.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Zuora.Client.Configuration.Default;
            RestClient = new RestClient(new RestClientOptions
            {
                BaseUrl = new UriBuilder( "https://rest.sandbox.na.zuora.com/v2").Uri,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://rest.sandbox.na.zuora.com/v2).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Zuora.Client.Configuration.Default;
