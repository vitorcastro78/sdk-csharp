...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FulfillmentItem :  IEquatable<FulfillmentItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentItem" /> class.
        /// </summary>
        ...
        /// <param name="fulfillmentId">Human-readable identifier for the object. It can be user-supplied..</param>
        public FulfillmentItem(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), string fulfillmentItemNumber = default(string), string fulfillmentId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  fulfillment_id: ").Append(fulfillment_id).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as FulfillmentItem);
        }

        /// <summary>
        /// Returns true if FulfillmentItem instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.fulfillment_id == input.fulfillment_id ||
                    (this.fulfillment_id != null &&
                    this.fulfillment_id.Equals(input.fulfillment_id))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.fulfillment_id != null)
                    hashCode = hashCode * 59 + this.fulfillment_id.GetHashCode();
                return hashCode;
            }
        }
