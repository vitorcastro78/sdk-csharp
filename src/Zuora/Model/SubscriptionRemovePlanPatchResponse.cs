...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionRemovePlanPatchResponse :  IEquatable<SubscriptionRemovePlanPatchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionRemovePlanPatchResponse" /> class.
        /// </summary>
        /// <param name="subscriptionPlanId">Identifier of the subscription plan..</param>
        public SubscriptionRemovePlanPatchResponse(string subscriptionPlanId = default(string))
        {
        ...
        {
            return this.Equals(input as SubscriptionRemovePlanPatchResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionRemovePlanPatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionRemovePlanPatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionRemovePlanPatchResponse input)
        {
            if (input == null)
                return false;
