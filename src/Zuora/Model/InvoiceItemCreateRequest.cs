...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceItemCreateRequest :  IEquatable<InvoiceItemCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItemCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceItemCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItemCreateRequest" /> class.
        /// </summary>
        ...
        public InvoiceItemCreateRequest(decimal amount = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), DateTime serviceEnd = default(DateTime), DateTime serviceStart = default(DateTime), string sku = default(string), bool taxInclusive = default(bool), string unitOfMeasure = default(string), List<TaxationItemCreateRequest> taxationItems = default(List<TaxationItemCreateRequest>), decimal unitAmount = default(decimal), string bookingReference = default(string), string priceId = default(string), string purchaseOrderNumber = default(string), string taxCode = default(string), DateTime documentItemDate = default(DateTime), string name = default(string), string accountingCode = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
            ...
            {
                throw new InvalidDataException("serviceStart is a required property for InvoiceItemCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InvoiceItemCreateRequest);
        }

        /// <summary>
        /// Returns true if InvoiceItemCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceItemCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceItemCreateRequest input)
        {
            if (input == null)
                return false;
