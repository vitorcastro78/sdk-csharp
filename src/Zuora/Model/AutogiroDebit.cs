...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutogiroDebit :  IEquatable<AutogiroDebit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutogiroDebit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutogiroDebit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutogiroDebit" /> class.
        /// </summary>
        /// <param name="accountNumber">The bank account number of the account holder. (required).</param>
        /// <param name="identityNumber">The identity number used for Autogiro (Direct Debit SE). (required).</param>
        ...
        public AutogiroDebit(string accountNumber = default(string), string identityNumber = default(string), string branchCode = default(string), Mandate mandate = default(Mandate))
        {
            // to ensure "accountNumber" is required (not null)
            if (accountNumber == null)
            {
                throw new InvalidDataException("accountNumber is a required property for AutogiroDebit and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identityNumber is a required property for AutogiroDebit and cannot be null");
            }
            else
            {
            ...
            if (branchCode == null)
            {
                throw new InvalidDataException("branchCode is a required property for AutogiroDebit and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AutogiroDebit);
        }

        /// <summary>
        /// Returns true if AutogiroDebit instances are equal
        /// </summary>
        /// <param name="input">Instance of AutogiroDebit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutogiroDebit input)
        {
            if (input == null)
                return false;
