...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuBecsDebit :  IEquatable<AuBecsDebit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuBecsDebit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuBecsDebit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuBecsDebit" /> class.
        /// </summary>
        ...
        public AuBecsDebit(string accountNumber = default(string), string branchCode = default(string), Mandate mandate = default(Mandate))
        {
            // to ensure "accountNumber" is required (not null)
            if (accountNumber == null)
            {
                throw new InvalidDataException("accountNumber is a required property for AuBecsDebit and cannot be null");
            }
            else
            {
            ...
            if (branchCode == null)
            {
                throw new InvalidDataException("branchCode is a required property for AuBecsDebit and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AuBecsDebit);
        }

        /// <summary>
        /// Returns true if AuBecsDebit instances are equal
        /// </summary>
        /// <param name="input">Instance of AuBecsDebit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuBecsDebit input)
        {
            if (input == null)
                return false;
