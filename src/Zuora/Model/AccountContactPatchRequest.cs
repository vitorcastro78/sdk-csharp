...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountContactPatchRequest :  IEquatable<AccountContactPatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountContactPatchRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountContactPatchRequest);
        }

        /// <summary>
        /// Returns true if AccountContactPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountContactPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountContactPatchRequest input)
        {
            if (input == null)
                return false;
