...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PadDebit :  IEquatable<PadDebit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PadDebit" /> class.
        /// </summary>
        ...
        public PadDebit(string accountNumber = default(string), string branchCode = default(string), string bankCode = default(string), Mandate mandate = default(Mandate))
        {
            // to ensure "accountNumber" is required (not null)
            if (accountNumber == null)
            {
                throw new InvalidDataException("accountNumber is a required property for PadDebit and cannot be null");
            }
            else
            {
            ...
            if (branchCode == null)
            {
                throw new InvalidDataException("branchCode is a required property for PadDebit and cannot be null");
            }
            else
            {
            ...
            if (bankCode == null)
            {
                throw new InvalidDataException("bankCode is a required property for PadDebit and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PadDebit);
        }

        /// <summary>
        /// Returns true if PadDebit instances are equal
        /// </summary>
        /// <param name="input">Instance of PadDebit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PadDebit input)
        {
            if (input == null)
                return false;
