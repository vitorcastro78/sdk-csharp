...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetByIdQueryParams : Dictionary<String, Object>,  IEquatable<GetByIdQueryParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetByIdQueryParams" /> class.
        /// </summary>
        ...
        public GetByIdQueryParams(List<string> expand = default(List<string>), List<string> filter = default(List<string>), int pageSize = default(int)) : base()
        {
            this.expand = expand;
            this.filter = filter;
        ...
        /// <summary>
        /// A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \&quot;Retrieve a billing document\&quot; operaiton, you can use the &#x60;filter[]&#x60; parameter on the related objects such as &#x60;filter[]&#x3D;items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63&#x60;
        /// </summary>
        /// <value>A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \&quot;Retrieve a billing document\&quot; operaiton, you can use the &#x60;filter[]&#x60; parameter on the related objects such as &#x60;filter[]&#x3D;items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63&#x60;</value>
        ...
        {
            return this.Equals(input as GetByIdQueryParams);
        }

        /// <summary>
        /// Returns true if GetByIdQueryParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetByIdQueryParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetByIdQueryParams input)
        {
            if (input == null)
                return false;
