...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionAddPlanPatchRequest :  IEquatable<SubscriptionAddPlanPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionAddPlanPatchRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscriptionAddPlanPatchRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionAddPlanPatchRequest" /> class.
        /// </summary>
        /// <param name="subscriptionPlan">subscriptionPlan (required).</param>
        /// <param name="startOn">startOn.</param>
        public SubscriptionAddPlanPatchRequest(SubscriptionPlanCreateRequest subscriptionPlan = default(SubscriptionPlanCreateRequest), StartOn startOn = default(StartOn))
        {
            // to ensure "subscriptionPlan" is required (not null)
            if (subscriptionPlan == null)
            {
                throw new InvalidDataException("subscriptionPlan is a required property for SubscriptionAddPlanPatchRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SubscriptionAddPlanPatchRequest);
        }

        /// <summary>
        /// Returns true if SubscriptionAddPlanPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionAddPlanPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionAddPlanPatchRequest input)
        {
            if (input == null)
                return false;
