...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlanPatchRequest :  IEquatable<PlanPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanPatchRequest" /> class.
        /// </summary>
        ...
        public PlanPatchRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string name = default(string), string planNumber = default(string), string description = default(string), List<string> activeCurrencies = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PlanPatchRequest);
        }

        /// <summary>
        /// Returns true if PlanPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PlanPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlanPatchRequest input)
        {
            if (input == null)
                return false;
