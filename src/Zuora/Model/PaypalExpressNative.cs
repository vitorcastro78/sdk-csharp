...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaypalExpressNative :  IEquatable<PaypalExpressNative>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaypalExpressNative" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaypalExpressNative() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaypalExpressNative" /> class.
        /// </summary>
        /// <param name="baid">Identifier of a PayPal billing agreement. For example, I-1TJ3GAGG82Y9. (required).</param>
        /// <param name="email">Email address associated with the payment method. This is required with a paypal_express_checkout or a paypal_adaptive payment method..</param>
        public PaypalExpressNative(string baid = default(string), string email = default(string))
        {
            // to ensure "baid" is required (not null)
            if (baid == null)
            {
                throw new InvalidDataException("baid is a required property for PaypalExpressNative and cannot be null");
            }
            else
            {
                this.baid = baid;
        ...
        {
            return this.Equals(input as PaypalExpressNative);
        }

        /// <summary>
        /// Returns true if PaypalExpressNative instances are equal
        /// </summary>
        /// <param name="input">Instance of PaypalExpressNative to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaypalExpressNative input)
        {
            if (input == null)
                return false;
