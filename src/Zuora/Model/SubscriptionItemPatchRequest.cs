...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionItemPatchRequest :  IEquatable<SubscriptionItemPatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionItemPatchRequest" /> class.
        /// </summary>
        /// <param name="id">Identifier of the subscription item..</param>
        /// <param name="recurring">recurring.</param>
        /// <param name="subscriptionItemNumber">Human-readable identifier of the subscription. It can be user-supplied..</param>
        ...
        /// <param name="applyDiscountTo">Any combination of one-time, recurring, or usage prices..</param>
        /// <param name="discountLevel">Specifies at what level a discount should be applied..</param>
        /// <param name="startEvent">Specifies when to start billing your customer..</param>
        /// <param name="discountPercent">Discount percent. Specify this field if you want to override with a discount-based discount price..</param>
        ...
        /// <param name="unitAmount">The unit amount of the price. Specify this field if you want to override the orignial price with a per-unit price..</param>
        /// <param name="tiers">Information of all tiers if you want to override the original price with a tiered price..</param>
        ...
        public SubscriptionItemPatchRequest(string id = default(string), Recurring recurring = default(Recurring), string subscriptionItemNumber = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), List<ApplyDiscountToEnum> applyDiscountTo = default(List<ApplyDiscountToEnum>), DiscountLevelEnum? discountLevel = default(DiscountLevelEnum?), StartEventEnum? startEvent = default(StartEventEnum?), decimal discountPercent = default(decimal), decimal quantity = default(decimal), decimal amount = default(decimal), decimal unitAmount = default(decimal), List<ItemTier> tiers = default(List<ItemTier>), Overage overage = default(Overage), string uniqueToken = default(string), SubscriptionItemPrepaymentField prepayment = default(SubscriptionItemPrepaymentField))
        {
            this.id = id;
        ...
        {
            return this.Equals(input as SubscriptionItemPatchRequest);
        }

        /// <summary>
        /// Returns true if SubscriptionItemPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionItemPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionItemPatchRequest input)
        {
            if (input == null)
                return false;
