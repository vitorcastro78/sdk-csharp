...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitMemoPatchRequest :  IEquatable<DebitMemoPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitMemoPatchRequest" /> class.
        /// </summary>
        ...
        public DebitMemoPatchRequest(bool pay = default(bool), string description = default(string), DateTime dueDate = default(DateTime), DateTime documentDate = default(DateTime), string reasonCode = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
            this.pay = pay;
        ...
        {
            return this.Equals(input as DebitMemoPatchRequest);
        }

        /// <summary>
        /// Returns true if DebitMemoPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitMemoPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitMemoPatchRequest input)
        {
            if (input == null)
                return false;
