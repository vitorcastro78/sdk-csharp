...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxationItem :  IEquatable<TaxationItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxationItem" /> class.
        /// </summary>
        ...
        public TaxationItem(string id = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), decimal amount = default(decimal), string taxCode = default(string), string taxCodeName = default(string), DateTime taxDate = default(DateTime), decimal taxRate = default(decimal), string taxRateName = default(string), decimal amountExempt = default(decimal), string sourceTaxItemId = default(string), string salesTaxPayableAccount = default(string), string onAccountAccount = default(string), bool taxInclusive = default(bool), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
            this.id = id;
        ...
        public decimal amount_credited { get; private set; }
        ...
        public decimal amount_refunded { get; private set; }
        ...
        public decimal amount_applied { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  amount_credited: ").Append(amount_credited).Append("\n");
        ...
        {
            return this.Equals(input as TaxationItem);
        }

        /// <summary>
        /// Returns true if TaxationItem instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxationItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.amount_credited == input.amount_credited ||
                    (this.amount_credited != null &&
                    this.amount_credited.Equals(input.amount_credited))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.amount_credited != null)
                    hashCode = hashCode * 59 + this.amount_credited.GetHashCode();
