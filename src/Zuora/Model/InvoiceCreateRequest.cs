...
namespace Zuora.Model
{
    ...
    public partial class InvoiceCreateRequest :  IEquatable<InvoiceCreateRequest>, IValidatableObject
    {
        ...
        /// <param name="items">Information of all invoice items..</param>
        /// <param name="post">Whether to automatically post an invoice after it is created..</param>
        public InvoiceCreateRequest(string accountId = default(string), string accountNumber = default(string), string description = default(string), DateTime dueDate = default(DateTime), DateTime documentDate = default(DateTime), bool transferToAccounting = default(bool), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), bool pay = default(bool), List<InvoiceItemCreateRequest> items = default(List<InvoiceItemCreateRequest>), bool post = default(bool))
        {
