...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BacsDebit :  IEquatable<BacsDebit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BacsDebit" /> class.
        /// </summary>
        ...
        public BacsDebit(string accountNumber = default(string), string bankCode = default(string), Mandate mandate = default(Mandate))
        {
            // to ensure "accountNumber" is required (not null)
            if (accountNumber == null)
            {
                throw new InvalidDataException("accountNumber is a required property for BacsDebit and cannot be null");
            }
            else
            {
            ...
            if (bankCode == null)
            {
                throw new InvalidDataException("bankCode is a required property for BacsDebit and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BacsDebit);
        }

        /// <summary>
        /// Returns true if BacsDebit instances are equal
        /// </summary>
        /// <param name="input">Instance of BacsDebit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BacsDebit input)
        {
            if (input == null)
                return false;
