...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingDocumentCreateRequest :  IEquatable<BillingDocumentCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingDocumentCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillingDocumentCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingDocumentCreateRequest" /> class.
        /// </summary>
        ...
        /// <param name="type">The type of billing document. Can be one of the credit memo, debit memo, or invoice. (required).</param>
        /// <param name="items">Information of all billing document items..</param>
        ...
        public BillingDocumentCreateRequest(string accountId = default(string), string accountNumber = default(string), string description = default(string), DateTime dueDate = default(DateTime), DateTime documentDate = default(DateTime), string reasonCode = default(string), string invoiceId = default(string), bool transferToAccounting = default(bool), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), bool excludeFromAutoApplyRules = default(bool), bool pay = default(bool), TypeEnum type = default(TypeEnum), List<BillingDocumentItemCreateRequest> items = default(List<BillingDocumentItemCreateRequest>), bool apply = default(bool), bool post = default(bool))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BillingDocumentCreateRequest and cannot be null");
            }
            else
            {
                this.type = type;
        ...
        {
            return this.Equals(input as BillingDocumentCreateRequest);
        }

        /// <summary>
        /// Returns true if BillingDocumentCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingDocumentCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingDocumentCreateRequest input)
        {
            if (input == null)
                return false;
