...
namespace Zuora.Model
{
    ...
    public partial class ApplePay :  IEquatable<ApplePay>, IValidatableObject
    {
        ...
        /// <param name="paymentId">The ID of newly processed payment. Only available in the response of the Create Payment Method API request..</param>
        ...
        public ApplePay(GetCardList card = default(GetCardList), Mandate mandate = default(Mandate), string paymentId = default(string), string token = default(string))
        {
            this.card = card;
            this.card = card;
        ...
        {
            return this.Equals(input as ApplePay);
        }
