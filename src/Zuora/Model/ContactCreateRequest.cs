...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactCreateRequest :  IEquatable<ContactCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected ContactCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactCreateRequest" /> class.
        /// </summary>
        ...
        /// <param name="accountId">Identifier of a customer account with which this contact is associated. Either &#x60;account_id&#x60; or &#x60;account_number&#x60; is required..</param>
        /// <param name="accountNumber">Human-readable identifier of the account with which this contact is associated. Either &#x60;account_number&#x60; or &#x60;account_id&#x60; is required..</param>
        public ContactCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), Address address = default(Address), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string email = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), OtherPhoneTypeEnum? otherPhoneType = default(OtherPhoneTypeEnum?), string fax = default(string), string accountId = default(string), string accountNumber = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new InvalidDataException("firstName is a required property for ContactCreateRequest and cannot be null");
            }
            else
            {
            ...
            if (lastName == null)
            {
                throw new InvalidDataException("lastName is a required property for ContactCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ContactCreateRequest);
        }

        /// <summary>
        /// Returns true if ContactCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactCreateRequest input)
        {
            if (input == null)
                return false;
