...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionResumePatchResponse :  IEquatable<SubscriptionResumePatchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionResumePatchResponse" /> class.
        /// </summary>
        ...
        public SubscriptionResumePatchResponse(bool extendTerm = false, DateTime resumeDate = default(DateTime), ResumeAtEnum? resumeAt = default(ResumeAtEnum?), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as SubscriptionResumePatchResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionResumePatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionResumePatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionResumePatchResponse input)
        {
            if (input == null)
                return false;
