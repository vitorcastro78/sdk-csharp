...
namespace Zuora.Model
{
    ...
    public partial class Product :  IEquatable<Product>, IValidatableObject
    {
        ...
        /// <param name="active">Whether the product can be used for new purchases..</param>
        public Product(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string name = default(string), TypeEnum? type = default(TypeEnum?), string sku = default(string), string description = default(string), bool active = default(bool))
        {
        ...
        public PlanListResponse plans { get; private set; }
