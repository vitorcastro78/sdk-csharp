...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionItemDrawdownField :  IEquatable<SubscriptionItemDrawdownField>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionItemDrawdownField" /> class.
        /// </summary>
        ...
        public SubscriptionItemDrawdownField(decimal conversionRate = default(decimal))
        {
        ...
        {
            return this.Equals(input as SubscriptionItemDrawdownField);
        }

        /// <summary>
        /// Returns true if SubscriptionItemDrawdownField instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionItemDrawdownField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionItemDrawdownField input)
        {
            if (input == null)
                return false;
