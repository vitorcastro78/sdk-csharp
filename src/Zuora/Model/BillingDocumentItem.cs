...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingDocumentItem :  IEquatable<BillingDocumentItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingDocumentItem" /> class.
        /// </summary>
        /// <param name="customFields">Set of user-defined fields associated with this object. Useful for storing additional information about the object in a structured format..</param>
        /// <param name="amount">The total amount of this billing document item..</param>
        ...
        /// <param name="billingDocumentId">The related billing document id..</param>
        ...
        /// <param name="serviceEnd">The end date of the service period associated with this billing document item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        ...
        /// <param name="serviceStart">The start date of the service period associated with this billing document item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        ...
        /// <param name="productName">The name of the product associated with this item..</param>
        /// <param name="subscriptionId">The identifier of the subscription associated with the billing document item..</param>
        /// <param name="subscription">The expandable subscription associated with the billing document item..</param>
        /// <param name="taxInclusive">This specifies if the billing document item amount is inclusive or exclusive of tax..</param>
        /// <param name="remainingBalance">The remaining balance of this billing document item..</param>
        /// <param name="unitOfMeasure">Specifies the units used to measure usage..</param>
        /// <param name="unitAmount">Unit amount (in the currency specified) of the billing document item..</param>
        /// <param name="bookingReference">The booking reference for this billing document item..</param>
        /// <param name="priceDescription">The description of the price this billing document item is associated with..</param>
        ...
        /// <param name="subscriptionItemId">The identifier the subscription item associated with this billing document item..</param>
        /// <param name="subscriptionItem">The expandable subscription item associated with this billing document item..</param>
        /// <param name="invoiceItemId">The identifier of the invoice item associated with this billing document item..</param>
        /// <param name="documentItemDate">The date when the billing document item takes effect..</param>
        /// <param name="taxationItems">List of taxation items..</param>
        /// <param name="type">The type of billing document, one of credit_memo, debit_memo or invoice..</param>
        public BillingDocumentItem(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), decimal amount = default(decimal), decimal subtotal = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), BillingDocument billingDocument = default(BillingDocument), string billingDocumentId = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), string serviceEnd = default(string), string accountsReceivableAccount = default(string), bool discountItem = default(bool), string appliedToItemId = default(string), string serviceStart = default(string), string accountingCode = default(string), string sku = default(string), string productName = default(string), string subscriptionId = default(string), Subscription subscription = default(Subscription), bool taxInclusive = default(bool), decimal remainingBalance = default(decimal), string unitOfMeasure = default(string), decimal unitAmount = default(decimal), string bookingReference = default(string), string priceDescription = default(string), string name = default(string), string priceId = default(string), string purchaseOrderNumber = default(string), decimal tax = default(decimal), string taxCode = default(string), string subscriptionItemId = default(string), SubscriptionItem subscriptionItem = default(SubscriptionItem), string invoiceItemId = default(string), DateTime documentItemDate = default(DateTime), TaxationItemListResponse taxationItems = default(TaxationItemListResponse), TypeEnum? type = default(TypeEnum?))
        {
        ...
        [DataMember(Name="taxation_items", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  price_description: ").Append(price_description).Append("\n");
        ...
        {
            return this.Equals(input as BillingDocumentItem);
        }

        /// <summary>
        /// Returns true if BillingDocumentItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingDocumentItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingDocumentItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.price_description == input.price_description ||
                    (this.price_description != null &&
                    this.price_description.Equals(input.price_description))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.price_description != null)
                    hashCode = hashCode * 59 + this.price_description.GetHashCode();
                if (this.name != null)
