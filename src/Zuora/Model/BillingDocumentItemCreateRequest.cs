...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingDocumentItemCreateRequest :  IEquatable<BillingDocumentItemCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingDocumentItemCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillingDocumentItemCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingDocumentItemCreateRequest" /> class.
        /// </summary>
        /// <param name="amount">Amount (in the currency specified) of the invoice item. This should always be equal to unit_amount * quantity..</param>
        ...
        /// <param name="serviceEnd">The end date of the service period associated with this billing document item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item..</param>
        /// <param name="serviceStart">The start date of the service period associated with this billing document item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item. (required).</param>
        /// <param name="sku">The unique SKU (stock keeping unit) of the product associated with this item..</param>
        /// <param name="taxInclusive">Indicates whether the billing document item amount is inclusive or exclusive of tax..</param>
        ...
        public BillingDocumentItemCreateRequest(decimal amount = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), DateTime serviceEnd = default(DateTime), DateTime serviceStart = default(DateTime), string sku = default(string), bool taxInclusive = default(bool), string unitOfMeasure = default(string), List<TaxationItemCreateRequest> taxationItems = default(List<TaxationItemCreateRequest>), decimal unitAmount = default(decimal), string bookingReference = default(string), string priceId = default(string), string purchaseOrderNumber = default(string), string taxCode = default(string), DateTime documentItemDate = default(DateTime), string name = default(string), string invoiceItemId = default(string), string accountingCode = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
            // to ensure "serviceStart" is required (not null)
            if (serviceStart == null)
            {
                throw new InvalidDataException("serviceStart is a required property for BillingDocumentItemCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BillingDocumentItemCreateRequest);
        }

        /// <summary>
        /// Returns true if BillingDocumentItemCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingDocumentItemCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingDocumentItemCreateRequest input)
        {
            if (input == null)
                return false;
