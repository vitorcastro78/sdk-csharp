...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FulfillmentPatchRequest :  IEquatable<FulfillmentPatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentPatchRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FulfillmentPatchRequest);
        }

        /// <summary>
        /// Returns true if FulfillmentPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentPatchRequest input)
        {
            if (input == null)
                return false;
