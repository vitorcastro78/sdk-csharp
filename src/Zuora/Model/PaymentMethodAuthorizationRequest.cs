...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentMethodAuthorizationRequest :  IEquatable<PaymentMethodAuthorizationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodAuthorizationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentMethodAuthorizationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodAuthorizationRequest" /> class.
        /// </summary>
        ...
        /// <param name="amount">Amount to be authorized. (required).</param>
        ...
        public PaymentMethodAuthorizationRequest(string accountId = default(string), string accountNumber = default(string), decimal amount = default(decimal), string gatewayId = default(string), Dictionary<string, string> gatewayOptions = default(Dictionary<string, string>), string gatewayOrderId = default(string), string statementDescriptor = default(string), string statementDescriptorPhone = default(string), AuthorizationMandate mandate = default(AuthorizationMandate))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for PaymentMethodAuthorizationRequest and cannot be null");
            }
            else
            {
                this.amount = amount;
            ...
            {
                throw new InvalidDataException("gatewayOrderId is a required property for PaymentMethodAuthorizationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentMethodAuthorizationRequest);
        }

        /// <summary>
        /// Returns true if PaymentMethodAuthorizationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodAuthorizationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodAuthorizationRequest input)
        {
            if (input == null)
                return false;
