...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentStateTransitions :  IEquatable<PaymentStateTransitions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentStateTransitions" /> class.
        /// </summary>
        /// <param name="canceledTime">The date and time (ISO 8601 UTC format) when the payment was canceled..</param>
        public PaymentStateTransitions(DateTime canceledTime = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PaymentStateTransitions);
        }

        /// <summary>
        /// Returns true if PaymentStateTransitions instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentStateTransitions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentStateTransitions input)
        {
            if (input == null)
                return false;
