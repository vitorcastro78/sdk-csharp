...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentMethodCreateRequest :  IEquatable<PaymentMethodCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentMethodCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCreateRequest" /> class.
        /// </summary>
        /// <param name="customFields">Set of user-defined fields associated with this object. Useful for storing additional information about the object in a structured format..</param>
        /// <param name="type">The type of the payment method. An additional hash is included on the payment method with a name matching this value. It contains additional information specific to the payment method type. (required).</param>
        ...
        /// <param name="isDefault">Indicates whether it is the default payment method on the associated account..</param>
        /// <param name="gatewayId">Identifier of the payment gateway Zuora will use to authorize the payments that are made with this payment method..</param>
        /// <param name="gatewayOptions">gatewayOptions.</param>
        public PaymentMethodCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), TypeEnum type = default(TypeEnum), string customType = default(string), string accountId = default(string), BillingDetails billingDetails = default(BillingDetails), decimal maximumPaymentAttempts = default(decimal), int paymentRetryInterval = default(int), string deviceSessionId = default(string), string ipAddress = default(string), string bankIdentificationNumber = default(string), Card card = default(Card), PaypalExpressNative paypalExpressNative = default(PaypalExpressNative), PaypalExpress paypalExpress = default(PaypalExpress), PaypalAdaptive paypalAdaptive = default(PaypalAdaptive), SepaDebit sepaDebit = default(SepaDebit), CcRef ccRef = default(CcRef), ApplePayCreate applePay = default(ApplePayCreate), GooglePayCreate googlePay = default(GooglePayCreate), AchDebit achDebit = default(AchDebit), BetalingsDebit betalingsDebit = default(BetalingsDebit), AutogiroDebit autogiroDebit = default(AutogiroDebit), BacsDebit bacsDebit = default(BacsDebit), AuBecsDebit auBecsDebit = default(AuBecsDebit), NzBecsDebit nzBecsDebit = default(NzBecsDebit), PadDebit padDebit = default(PadDebit), string accountNumber = default(string), bool isDefault = default(bool), string gatewayId = default(string), Dictionary<string, string> gatewayOptions = default(Dictionary<string, string>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PaymentMethodCreateRequest and cannot be null");
            }
            else
            {
                this.type = type;
        ...
        public ApplePayCreate apple_pay { get; set; }

        /// <summary>
        /// Gets or Sets google_pay
        /// </summary>
        [DataMember(Name="google_pay", EmitDefaultValue=false)]
        public GooglePayCreate google_pay { get; set; }
        ...
        {
            return this.Equals(input as PaymentMethodCreateRequest);
        }

        /// <summary>
        /// Returns true if PaymentMethodCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodCreateRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.is_default.Equals(input.is_default))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.is_default != null)
                    hashCode = hashCode * 59 + this.is_default.GetHashCode();
