...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionVersionOrder :  IEquatable<SubscriptionVersionOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionVersionOrder" /> class.
        /// </summary>
        ...
        public SubscriptionVersionOrder(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string orderNumber = default(string), DateTime orderDate = default(DateTime), string description = default(string), CategoryEnum? category = default(CategoryEnum?), LineItemListResponse lineItems = default(LineItemListResponse), StateEnum? state = default(StateEnum?), OrderActionListResponse actions = default(OrderActionListResponse))
        {
        ...
        public OrderActionListResponse actions { get; set; }
        ...
        {
            return this.Equals(input as SubscriptionVersionOrder);
        }

        /// <summary>
        /// Returns true if SubscriptionVersionOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionVersionOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionVersionOrder input)
        {
            if (input == null)
                return false;
