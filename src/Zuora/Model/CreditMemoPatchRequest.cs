...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditMemoPatchRequest :  IEquatable<CreditMemoPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditMemoPatchRequest" /> class.
        /// </summary>
        ...
        public CreditMemoPatchRequest(bool apply = default(bool), DateTime documentDate = default(DateTime), string reasonCode = default(string), bool transferToAccounting = default(bool), bool excludeFromAutoApplyRules = default(bool), string description = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
            this.apply = apply;
        ...
        {
            return this.Equals(input as CreditMemoPatchRequest);
        }

        /// <summary>
        /// Returns true if CreditMemoPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditMemoPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemoPatchRequest input)
        {
            if (input == null)
                return false;
