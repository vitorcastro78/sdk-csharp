...
namespace Zuora.Model
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        /// <param name="state">State or providence.</param>
        /// <param name="country">Two-letter country code (ISO 3166-1 alpha-2)..</param>
        /// <param name="county">Zuora Tax uses this information to calculate county taxation..</param>
        /// <param name="postalCode">ZIP or postal code..</param>
        public Address(string line1 = default(string), string line2 = default(string), string city = default(string), string state = default(string), string country = default(string), string county = default(string), string postalCode = default(string))
        {
            this.line1 = line1;
            this.line2 = line2;
            this.city = city;
