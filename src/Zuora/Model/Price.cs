...
namespace Zuora.Model
{
    ...
    public partial class Price :  IEquatable<Price>, IValidatableObject
    {
        ...
        /// <param name="name">The name of the price..</param>
        ...
        /// <param name="priceBaseInterval">Specifies the base interval of a price. If not provided, this field defaults to &#x60;billing_period&#x60;..</param>
        ...
        /// <param name="active">Whether the price can be used for new purchases..</param>
        /// <param name="chargeType">The type of charge. Can be &#x60;one_time&#x60;,&#x60;recurring&#x60;, or &#x60;usage&#x60;..</param>
        /// <param name="chargeModel">The charge model of the price, which determines how users are charged. Common charge models include flat fee, per-unit, volume, and tiered prices..</param>
        public Price(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string name = default(string), string description = default(string), string recognizedRevenueAccountingCode = default(string), string deferredRevenueAccountingCode = default(string), Recurring recurring = default(Recurring), StartEventEnum? startEvent = default(StartEventEnum?), TiersModeEnum? tiersMode = default(TiersModeEnum?), List<ApplyDiscountToEnum> applyDiscountTo = default(List<ApplyDiscountToEnum>), List<Tier> tiers = default(List<Tier>), string taxCode = default(string), bool taxInclusive = default(bool), string unitOfMeasure = default(string), decimal quantity = default(decimal), decimal minQuantity = default(decimal), decimal maxQuantity = default(decimal), DiscountLevelEnum? discountLevel = default(DiscountLevelEnum?), RevenueRecognitionRuleEnum? revenueRecognitionRule = default(RevenueRecognitionRuleEnum?), bool stackedDiscount = default(bool), Dictionary<string, decimal> amounts = default(Dictionary<string, decimal>), Dictionary<string, decimal> unitAmounts = default(Dictionary<string, decimal>), Dictionary<string, decimal> discountAmounts = default(Dictionary<string, decimal>), decimal discountPercent = default(decimal), PriceBaseIntervalEnum? priceBaseInterval = default(PriceBaseIntervalEnum?), Overage overage = default(Overage), Revenue revenue = default(Revenue), string accountingCode = default(string), Prepayment prepayment = default(Prepayment), Drawdown drawdown = default(Drawdown), bool taxable = default(bool), string planId = default(string), string planNumber = default(string), string productId = default(string), bool active = default(bool), string chargeType = default(string), string chargeModel = default(string))
        {
