...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CcRefCard :  IEquatable<CcRefCard>, IValidatableObject
    {
        /// <summary>
        /// Card brand.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CcRefCard" /> class.
        /// </summary>
        ...
        public CcRefCard(BrandEnum? brand = default(BrandEnum?), decimal expiryMonth = default(decimal), decimal expiryYear = default(decimal))
        {
            this.brand = brand;
        ...
        {
            return this.Equals(input as CcRefCard);
        }

        /// <summary>
        /// Returns true if CcRefCard instances are equal
        /// </summary>
        /// <param name="input">Instance of CcRefCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CcRefCard input)
        {
            if (input == null)
                return false;
