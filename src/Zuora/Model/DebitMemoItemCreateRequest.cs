...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitMemoItemCreateRequest :  IEquatable<DebitMemoItemCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitMemoItemCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DebitMemoItemCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitMemoItemCreateRequest" /> class.
        /// </summary>
        /// <param name="amount">Amount of the memo item. This should always be equal to unit_amount * quantity..</param>
        ...
        /// <param name="serviceEnd">The end date of the service period associated with this debit memo item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item..</param>
        /// <param name="serviceStart">The start date of the service period associated with this debit memo item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item. (required).</param>
        /// <param name="sku">The unique SKU (stock keeping unit) of the product associated with this item..</param>
        /// <param name="taxInclusive">Indicates whether the debit memo item amount is inclusive or exclusive of tax..</param>
        ...
        /// <param name="name">Name of the debit memo item displayed to customers on the billing document..</param>
        ...
        /// <param name="documentItemDate">The date when the billing document item takes effect. This field is applicable only if the &#x60;type&#x60; field is set to &#x60;invoice&#x60;..</param>
        /// <param name="customFields">Set of user-defined fields associated with this object. Useful for storing additional information about the object in a structured format..</param>
        public DebitMemoItemCreateRequest(decimal amount = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), DateTime serviceEnd = default(DateTime), DateTime serviceStart = default(DateTime), string sku = default(string), bool taxInclusive = default(bool), string unitOfMeasure = default(string), List<TaxationItemCreateRequest> taxationItems = default(List<TaxationItemCreateRequest>), decimal unitAmount = default(decimal), string priceId = default(string), string purchaseOrderNumber = default(string), string taxCode = default(string), string name = default(string), string invoiceItemId = default(string), string accountingCode = default(string), DateTime documentItemDate = default(DateTime), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
            // to ensure "serviceStart" is required (not null)
            if (serviceStart == null)
            {
                throw new InvalidDataException("serviceStart is a required property for DebitMemoItemCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DebitMemoItemCreateRequest);
        }

        /// <summary>
        /// Returns true if DebitMemoItemCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitMemoItemCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitMemoItemCreateRequest input)
        {
            if (input == null)
                return false;
