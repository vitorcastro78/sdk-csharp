...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitMemoCreateRequest :  IEquatable<DebitMemoCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitMemoCreateRequest" /> class.
        /// </summary>
        ...
        /// <param name="dueDate">The date on which payment for the debit memo is due..</param>
        ...
        {
            return this.Equals(input as DebitMemoCreateRequest);
        }

        /// <summary>
        /// Returns true if DebitMemoCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitMemoCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitMemoCreateRequest input)
        {
            if (input == null)
                return false;
