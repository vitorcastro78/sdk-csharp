...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayInvoiceRequest :  IEquatable<PayInvoiceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayInvoiceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayInvoiceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayInvoiceRequest" /> class.
        /// </summary>
        /// <param name="amount">The amount of the payment..</param>
        /// <param name="accountId">Identifier of the account that owns the invoice. Either &#x60;account_id&#x60; or &#x60;account_number&#x60; is required..</param>
        /// <param name="accountNumber">Human-readable identifier of the account that owns the invoice. Either &#x60;account_number&#x60; or &#x60;account_id&#x60; is required..</param>
        ...
        {
            return this.Equals(input as PayInvoiceRequest);
        }

        /// <summary>
        /// Returns true if PayInvoiceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PayInvoiceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayInvoiceRequest input)
        {
            if (input == null)
                return false;
