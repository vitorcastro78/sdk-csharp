...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionPausePatchResponse :  IEquatable<SubscriptionPausePatchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPausePatchResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SubscriptionPausePatchResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionPausePatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionPausePatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionPausePatchResponse input)
        {
            if (input == null)
                return false;
