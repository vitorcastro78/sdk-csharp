...
namespace Zuora.Model
{
    ...
    public partial class AccountCreateRequest :  IEquatable<AccountCreateRequest>, IValidatableObject
    {
        ...
        /// <param name="billTo">Customer billing address. (required).</param>
        ...
        /// <param name="name">The name of the customer account. (required).</param>
        ...
        public AccountCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string accountNumber = default(string), BillingDocumentSettings billingDocumentSettings = default(BillingDocumentSettings), string batch = default(string), int billCycleDay = default(int), AccountContactCreateRequest billTo = default(AccountContactCreateRequest), AccountContactCreateRequest soldTo = default(AccountContactCreateRequest), string communicationProfileId = default(string), string crmId = default(string), string defaultPaymentMethodId = default(string), string name = default(string), string description = default(string), string parentAccountId = default(string), string paymentGateway = default(string), string paymentTerms = default(string), string sequenceSetId = default(string), bool autoPay = default(bool), TaxCertificate taxCertificate = default(TaxCertificate), TaxIdentifier taxIdentifier = default(TaxIdentifier), string currency = default(string), string salesRep = default(string), AccountPaymentMethodRequest paymentMethod = default(AccountPaymentMethodRequest))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AccountCreateRequest and cannot be null");
            }
            else
            {
                this.name = name;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for AccountCreateRequest and cannot be null");
            }
            else
            {
        ...
        public AccountContactCreateRequest bill_to { get; set; }
        ...
        public AccountPaymentMethodRequest payment_method { get; set; }
