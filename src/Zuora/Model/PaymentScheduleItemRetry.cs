...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentScheduleItemRetry :  IEquatable<PaymentScheduleItemRetry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentScheduleItemRetry" /> class.
        /// </summary>
        ...
        public PaymentScheduleItemRetry(string paymentGatewayId = default(string), string paymentMethodId = default(string))
        {
        ...
        {
            return this.Equals(input as PaymentScheduleItemRetry);
        }

        /// <summary>
        /// Returns true if PaymentScheduleItemRetry instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentScheduleItemRetry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleItemRetry input)
        {
            if (input == null)
                return false;
