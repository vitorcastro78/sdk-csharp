...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderPreviewResponse :  IEquatable<OrderPreviewResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderPreviewResponse" /> class.
        /// </summary>
        /// <param name="subscriptions">subscriptions.</param>
        /// <param name="billingDocuments">billingDocuments.</param>
        public OrderPreviewResponse(List<OrderSubscriptionPreviewResponse> subscriptions = default(List<OrderSubscriptionPreviewResponse>), List<SubscriptionPreviewBillingDocumentsResponse> billingDocuments = default(List<SubscriptionPreviewBillingDocumentsResponse>))
        {
        ...
        public List<OrderSubscriptionPreviewResponse> subscriptions { get; set; }
        ...
        {
            return this.Equals(input as OrderPreviewResponse);
        }

        /// <summary>
        /// Returns true if OrderPreviewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderPreviewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderPreviewResponse input)
        {
            if (input == null)
                return false;
