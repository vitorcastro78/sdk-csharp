...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditMemoItem :  IEquatable<CreditMemoItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditMemoItem" /> class.
        /// </summary>
        ...
        /// <param name="creditMemoId">The related credit memo id..</param>
        ...
        /// <param name="serviceEnd">The end date of the service period associated with this credit memo item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        /// <param name="serviceStart">The start date of the service period associated with this credit memo item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        ...
        /// <param name="taxInclusive">This specifies if the credit memo item amount is inclusive or exclusive of tax..</param>
        /// <param name="remainingBalance">The remaining balance of this credit memo item..</param>
        ...
        /// <param name="name">Name of the credit memo item displayed to customers on the billing document..</param>
        /// <param name="priceId">The identifier of the price this credit memo item is associated with..</param>
        /// <param name="purchaseOrderNumber">The purchase order number associated with this credit memo item..</param>
        /// <param name="tax">The amount of tax applied to the credit memo item..</param>
        ...
        public CreditMemoItem(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), decimal amount = default(decimal), decimal subtotal = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), CreditMemo creditMemo = default(CreditMemo), string creditMemoId = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), string serviceEnd = default(string), string serviceStart = default(string), string accountsReceivableAccount = default(string), bool discountItem = default(bool), string appliedToItemId = default(string), string accountingCode = default(string), string sku = default(string), bool taxInclusive = default(bool), decimal remainingBalance = default(decimal), string unitOfMeasure = default(string), decimal unitAmount = default(decimal), string name = default(string), string priceId = default(string), string purchaseOrderNumber = default(string), decimal tax = default(decimal), string taxCode = default(string), string subscriptionId = default(string), string subscriptionItemId = default(string), string invoiceItemId = default(string), DateTime documentItemDate = default(DateTime), TaxationItemListResponse taxationItems = default(TaxationItemListResponse), SubscriptionItem subscriptionItem = default(SubscriptionItem))
        {
            ...
            this.credit_memo = creditMemo;
            this.credit_memo_id = creditMemoId;
        ...
        public CreditMemo credit_memo { get; set; }
        ...
        public string credit_memo_id { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  credit_memo_id: ").Append(credit_memo_id).Append("\n");
        ...
        {
            return this.Equals(input as CreditMemoItem);
        }

        /// <summary>
        /// Returns true if CreditMemoItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditMemoItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemoItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.credit_memo_id == input.credit_memo_id ||
                    (this.credit_memo_id != null &&
                    this.credit_memo_id.Equals(input.credit_memo_id))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.credit_memo_id != null)
                    hashCode = hashCode * 59 + this.credit_memo_id.GetHashCode();
