...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditMemoAppliedToResponse :  IEquatable<CreditMemoAppliedToResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditMemoAppliedToResponse" /> class.
        /// </summary>
        /// <param name="billingDocumentId">Identifier of an invoice or a debit memo..</param>
        /// <param name="id">Identifier of the credit memo application.</param>
        ...
        public CreditMemoAppliedToResponse(string billingDocumentId = default(string), string id = default(string), decimal amount = default(decimal), BillingDocument billingDocument = default(BillingDocument), BillingDocumentTypeEnum? billingDocumentType = default(BillingDocumentTypeEnum?))
        {
        ...
        {
            return this.Equals(input as CreditMemoAppliedToResponse);
        }

        /// <summary>
        /// Returns true if CreditMemoAppliedToResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditMemoAppliedToResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemoAppliedToResponse input)
        {
            if (input == null)
                return false;
