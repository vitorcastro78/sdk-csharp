...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FulfillmentProcessingOption :  IEquatable<FulfillmentProcessingOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentProcessingOption" /> class.
        /// </summary>
        /// <param name="documentDate">Date on which the billing document is created or paid..</param>
        /// <param name="targetDate">The target date for the order to be picked up by bill run for billing..</param>
        public FulfillmentProcessingOption(DateTime documentDate = default(DateTime), DateTime targetDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as FulfillmentProcessingOption);
        }

        /// <summary>
        /// Returns true if FulfillmentProcessingOption instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentProcessingOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentProcessingOption input)
        {
            if (input == null)
                return false;
