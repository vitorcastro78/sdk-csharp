...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductCreateRequest :  IEquatable<ProductCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// The type of product.
        /// </summary>
        ...
        public ProductCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string name = default(string), TypeEnum? type = default(TypeEnum?), string sku = default(string), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductCreateRequest and cannot be null");
            }
            else
            {
                this.name = name;
        ...
        {
            return this.Equals(input as ProductCreateRequest);
        }

        /// <summary>
        /// Returns true if ProductCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductCreateRequest input)
        {
            if (input == null)
                return false;
