...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditMemo :  IEquatable<CreditMemo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="amountRefunded">The amount this billing document refunded..</param>
        ...
        public string credit_memo_number { get; private set; }
        ...
        public CreditMemoItemListResponse items { get; private set; }
        ...
        public List<CreditMemoAppliedToResponse> applied_to { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  credit_memo_number: ").Append(credit_memo_number).Append("\n");
        ...
        {
            return this.Equals(input as CreditMemo);
        }

        /// <summary>
        /// Returns true if CreditMemo instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditMemo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemo input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.credit_memo_number == input.credit_memo_number ||
                    (this.credit_memo_number != null &&
                    this.credit_memo_number.Equals(input.credit_memo_number))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.credit_memo_number != null)
                    hashCode = hashCode * 59 + this.credit_memo_number.GetHashCode();
