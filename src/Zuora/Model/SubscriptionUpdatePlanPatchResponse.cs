...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionUpdatePlanPatchResponse :  IEquatable<SubscriptionUpdatePlanPatchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionUpdatePlanPatchResponse" /> class.
        /// </summary>
        ...
        public SubscriptionUpdatePlanPatchResponse(string uniqueToken = default(string), string planId = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as SubscriptionUpdatePlanPatchResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionUpdatePlanPatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionUpdatePlanPatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionUpdatePlanPatchResponse input)
        {
            if (input == null)
                return false;
