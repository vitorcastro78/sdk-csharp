...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitMemoItem :  IEquatable<DebitMemoItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitMemoItem" /> class.
        /// </summary>
        /// <param name="customFields">Set of user-defined fields associated with this object. Useful for storing additional information about the object in a structured format..</param>
        /// <param name="amount">The total amount of this debit memo item..</param>
        /// <param name="subtotal">The total amount of this debit memo item exclusive of tax..</param>
        ...
        /// <param name="onAccountAccount">The accounting code that maps to an on account in your accounting system..</param>
        ...
        /// <param name="serviceEnd">The end date of the service period associated with this debit memo item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        /// <param name="serviceStart">The start date of the service period associated with this debit memo item. If the associated charge is a one-time fee, then this date is the date of that charge..</param>
        ...
        /// <param name="appliedToItemId">Identifier of an invoice item that this debit memo item is applied to..</param>
        ...
        /// <param name="taxInclusive">This specifies if the debit memo item amount is inclusive or exclusive of tax..</param>
        /// <param name="remainingBalance">The remaining balance of this debit memo item..</param>
        /// <param name="unitOfMeasure">Specifies the units used to measure usage..</param>
        /// <param name="unitAmount">Unit amount of the debit memo item..</param>
        /// <param name="name">Name of the billing document item displayed to customers on the billing document..</param>
        /// <param name="priceId">The identifier of the price this debit memo item is associated with..</param>
        /// <param name="purchaseOrderNumber">The purchase order number associated with this debit memo item..</param>
        /// <param name="tax">The amount of tax applied to the debit memo item..</param>
        /// <param name="taxCode">The designated tax code..</param>
        /// <param name="subscriptionId">The identifier of the subscription associated with the debit memo item..</param>
        /// <param name="subscriptionItemId">The identifier the subscription item associated with this debit memo item..</param>
        /// <param name="invoiceItemId">The identifier of the invoice item associated with this debit memo item..</param>
        /// <param name="documentItemDate">The date when the debit memo item takes effect..</param>
        /// <param name="taxationItems">taxationItems.</param>
        /// <param name="debitMemo">The related debit memo..</param>
        /// <param name="debitMemoId">The related debit memo id..</param>
        /// <param name="subscriptionItem">The expandable subscription item associated with this billing document item..</param>
        public DebitMemoItem(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), decimal amount = default(decimal), decimal subtotal = default(decimal), string description = default(string), string deferredRevenueAccount = default(string), string onAccountAccount = default(string), string recognizedRevenueAccount = default(string), string revenueRecognitionRuleName = default(string), decimal quantity = default(decimal), string serviceEnd = default(string), string serviceStart = default(string), string accountsReceivableAccount = default(string), bool discountItem = default(bool), string appliedToItemId = default(string), string accountingCode = default(string), string sku = default(string), bool taxInclusive = default(bool), decimal remainingBalance = default(decimal), string unitOfMeasure = default(string), decimal unitAmount = default(decimal), string name = default(string), string priceId = default(string), string purchaseOrderNumber = default(string), decimal tax = default(decimal), string taxCode = default(string), string subscriptionId = default(string), string subscriptionItemId = default(string), string invoiceItemId = default(string), DateTime documentItemDate = default(DateTime), TaxationItemListResponse taxationItems = default(TaxationItemListResponse), DebitMemo debitMemo = default(DebitMemo), string debitMemoId = default(string), SubscriptionItem subscriptionItem = default(SubscriptionItem))
        {
            this.debit_memo = debitMemo;
            ...
            this.debit_memo = debitMemo;
            this.debit_memo_id = debitMemoId;
            this.subscription_item = subscriptionItem;
        }
        ...
        [DataMember(Name="debit_memo", EmitDefaultValue=true)]
        public DebitMemo debit_memo { get; set; }
        ...
        public string debit_memo_id { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  debit_memo: ").Append(debit_memo).Append("\n");
            sb.Append("  debit_memo_id: ").Append(debit_memo_id).Append("\n");
        ...
        {
            return this.Equals(input as DebitMemoItem);
        }

        /// <summary>
        /// Returns true if DebitMemoItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitMemoItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitMemoItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.debit_memo == input.debit_memo ||
                    (this.debit_memo != null &&
                    this.debit_memo.Equals(input.debit_memo))
                ) && 
                (
                    this.debit_memo_id == input.debit_memo_id ||
                    (this.debit_memo_id != null &&
                    this.debit_memo_id.Equals(input.debit_memo_id))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.debit_memo != null)
                    hashCode = hashCode * 59 + this.debit_memo.GetHashCode();
                if (this.debit_memo_id != null)
                    hashCode = hashCode * 59 + this.debit_memo_id.GetHashCode();
