...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlanCreateRequest :  IEquatable<PlanCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlanCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanCreateRequest" /> class.
        /// </summary>
        ...
        /// <param name="productId">Identifier of the product associated with this plan. (required).</param>
        public PlanCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string name = default(string), string planNumber = default(string), string description = default(string), List<string> activeCurrencies = default(List<string>), string productId = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PlanCreateRequest and cannot be null");
            }
            else
            {
                this.name = name;
            ...
            if (productId == null)
            {
                throw new InvalidDataException("productId is a required property for PlanCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PlanCreateRequest);
        }

        /// <summary>
        /// Returns true if PlanCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PlanCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlanCreateRequest input)
        {
            if (input == null)
                return false;
