...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PricePatchRequest :  IEquatable<PricePatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricePatchRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PricePatchRequest);
        }

        /// <summary>
        /// Returns true if PricePatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PricePatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricePatchRequest input)
        {
            if (input == null)
                return false;
