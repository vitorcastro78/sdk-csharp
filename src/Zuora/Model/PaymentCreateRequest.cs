...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentCreateRequest :  IEquatable<PaymentCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="amount">The total amount of the payment. (required).</param>
        /// <param name="authorizationId">Identifier of the authorization transaction from the payment gateway..</param>
        /// <param name="paymentDate">The date and time when the payment takes effect. (required).</param>
        /// <param name="paymentMethodId">Identifier of the payment method used to create this payment. (required).</param>
        ...
        /// <param name="billingDocuments">Indicates to which billing documents (invoices or debit memos) are the payment applied..</param>
        public PaymentCreateRequest(Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), string referenceId = default(string), string accountId = default(string), string accountNumber = default(string), decimal amount = default(decimal), string authorizationId = default(string), DateTime paymentDate = default(DateTime), string paymentMethodId = default(string), string gatewayId = default(string), string gatewayOrderId = default(string), string secondReferenceId = default(string), Dictionary<string, string> gatewayOptions = default(Dictionary<string, string>), string statementDescriptor = default(string), string statementDescriptorPhone = default(string), bool external = default(bool), string currency = default(string), List<BillingDocumentPaymentApplicationRequest> billingDocuments = default(List<BillingDocumentPaymentApplicationRequest>))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for PaymentCreateRequest and cannot be null");
            }
            else
            {
                this.amount = amount;
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for PaymentCreateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethodId is a required property for PaymentCreateRequest and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for PaymentCreateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentCreateRequest);
        }

        /// <summary>
        /// Returns true if PaymentCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentCreateRequest input)
        {
            if (input == null)
                return false;
