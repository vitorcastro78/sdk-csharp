...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsAppliedToResponse :  IEquatable<PaymentsAppliedToResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsAppliedToResponse" /> class.
        /// </summary>
        /// <param name="billingDocumentId">Identifier of an invoice or a debit memo..</param>
        /// <param name="id">Identifier of the payment application..</param>
        ...
        /// <param name="billingDocumentType">The type of billing document. Can be one of the debit memo or invoice..</param>
        /// <param name="items">The related billing document item..</param>
        public PaymentsAppliedToResponse(string billingDocumentId = default(string), string id = default(string), decimal amount = default(decimal), BillingDocument billingDocument = default(BillingDocument), BillingDocumentTypeEnum? billingDocumentType = default(BillingDocumentTypeEnum?), List<PaymentAppliedToBillingItemResponse> items = default(List<PaymentAppliedToBillingItemResponse>))
        {
        ...
        {
            return this.Equals(input as PaymentsAppliedToResponse);
        }

        /// <summary>
        /// Returns true if PaymentsAppliedToResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentsAppliedToResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsAppliedToResponse input)
        {
            if (input == null)
                return false;
