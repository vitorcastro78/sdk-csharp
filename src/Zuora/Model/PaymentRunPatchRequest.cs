...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentRunPatchRequest :  IEquatable<PaymentRunPatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRunPatchRequest" /> class.
        /// </summary>
        ...
        public PaymentRunPatchRequest(bool applyCreditMemos = default(bool), bool applyUnappliedPayments = default(bool), string batch = default(string), string billCycleDay = default(string), string billRunId = default(string), bool collectPayment = default(bool), string currency = default(string), bool consolidatedPayment = default(bool), string gatewayId = default(string), DateTime paymentRunDate = default(DateTime), DateTime targetDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as PaymentRunPatchRequest);
        }

        /// <summary>
        /// Returns true if PaymentRunPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRunPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRunPatchRequest input)
        {
            if (input == null)
                return false;
