...
namespace Zuora.Model
{
    ...
    public partial class SubscriptionVersion :  IEquatable<SubscriptionVersion>, IValidatableObject
    {
        ...
        public SubscriptionVersionOrder order { get; set; }
