...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionActivateRequest :  IEquatable<SubscriptionActivateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public SubscriptionActivateRequest(DateTime contractEffective = default(DateTime), DateTime serviceActivation = default(DateTime), DateTime customerAcceptance = default(DateTime))
        {
        ...
        {
            return this.Equals(input as SubscriptionActivateRequest);
        }

        /// <summary>
        /// Returns true if SubscriptionActivateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionActivateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionActivateRequest input)
        {
            if (input == null)
                return false;
