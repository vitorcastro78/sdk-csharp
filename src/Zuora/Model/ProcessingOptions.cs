...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessingOptions :  IEquatable<ProcessingOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public ProcessingOptions(DateTime documentDate = default(DateTime), DateTime targetDate = default(DateTime), CollectionMethodEnum? collectionMethod = default(CollectionMethodEnum?), string paymentMethodId = default(string))
        {
        ...
        {
            return this.Equals(input as ProcessingOptions);
        }

        /// <summary>
        /// Returns true if ProcessingOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessingOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessingOptions input)
        {
            if (input == null)
                return false;
