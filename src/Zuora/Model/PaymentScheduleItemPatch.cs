...
namespace Zuora.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentScheduleItemPatch :  IEquatable<PaymentScheduleItemPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentScheduleItemPatch" /> class.
        /// </summary>
        ...
        /// <param name="unlink">unlink.</param>
        public PaymentScheduleItemPatch(string paymentScheduleId = default(string), string paymentScheduleNumber = default(string), decimal amount = default(decimal), string currency = default(string), string description = default(string), string paymentGatewayId = default(string), string paymentMethodId = default(string), DateTime scheduledDate = default(DateTime), int runHour = default(int), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), List<PaymentScheduleItemPaymentOption> paymentOptions = default(List<PaymentScheduleItemPaymentOption>), List<PaymentScheduleItemLink> link = default(List<PaymentScheduleItemLink>), List<PaymentScheduleItemUnlink> unlink = default(List<PaymentScheduleItemUnlink>))
        {
        ...
        {
            return this.Equals(input as PaymentScheduleItemPatch);
        }

        /// <summary>
        /// Returns true if PaymentScheduleItemPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentScheduleItemPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleItemPatch input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.unlink != null &&
                    input.unlink != null &&
                    this.unlink.SequenceEqual(input.unlink)
                );
        }
