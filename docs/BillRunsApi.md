# Zuora.Api.BillRunsApi

All URIs are relative to *https://rest.sandbox.na.zuora.com/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**CancelBillRun**](BillRunsApi.md#cancelbillrun) | **POST** /bill_runs/{bill_run_id}/cancel | Cancel a bill run
[**CreateBillRun**](BillRunsApi.md#createbillrun) | **POST** /bill_runs | Create a bill run
[**DeleteBillRun**](BillRunsApi.md#deletebillrun) | **DELETE** /bill_runs/{bill_run_id} | Delete a bill run
[**GetBillRun**](BillRunsApi.md#getbillrun) | **GET** /bill_runs/{bill_run_id} | Retrieve a bill run
[**GetBillRuns**](BillRunsApi.md#getbillruns) | **GET** /bill_runs | List bill runs
[**PostBillRun**](BillRunsApi.md#postbillrun) | **POST** /bill_runs/{bill_run_id}/post | Post a bill run



## CancelBillRun

> BillRun CancelBillRun (string billRunId, List<string> fields = null, List<string> expand = null, List<string> filter = null, int? pageSize = null, string zuoraTrackId = null, bool? async = null, string zuoraEntityId = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class CancelBillRunExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new BillRunsApi(Configuration.Default);
            var billRunId = billRunId_example;  // string | Identifier for the bill run, either `bill_run_number` or `bill_run_id`
            var fields = new List<string>(); // List<string> | Allows you to specify which fields are returned in the response.          <details>            <summary> Accepted values </summary>              `custom_fields`, `created_by_id`, `updated_by_id`, `created_time`, `id`, `updated_time`, `account_id`, `email`, `post`, `renew`, `batches`, `day_of_month`, `charges_excluded`, `invoice_date`, `email_zero_amount_invoices`, `target_date`, `bill_run_number`, `bill_run_time`, `invoices_sent`, `last_invoice_sent_time`, `accounts_processed`, `invoices_generated`, `credit_memos_generated`, `state`, `name`          </details> (optional) 
            ...
            {
                // Cancel a bill run
                BillRun result = apiInstance.CancelBillRun(billRunId, fields, expand, filter, pageSize, zuoraTrackId, async, zuoraEntityId, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.CancelBillRun: " + e.Message );
...
------------- | ------------- | ------------- | -------------
 **billRunId** | **string**| Identifier for the bill run, either &#x60;bill_run_number&#x60; or &#x60;bill_run_id&#x60; | 
 **fields** | [**List&lt;string&gt;**](string.md)| Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;account_id&#x60;, &#x60;email&#x60;, &#x60;post&#x60;, &#x60;renew&#x60;, &#x60;batches&#x60;, &#x60;day_of_month&#x60;, &#x60;charges_excluded&#x60;, &#x60;invoice_date&#x60;, &#x60;email_zero_amount_invoices&#x60;, &#x60;target_date&#x60;, &#x60;bill_run_number&#x60;, &#x60;bill_run_time&#x60;, &#x60;invoices_sent&#x60;, &#x60;last_invoice_sent_time&#x60;, &#x60;accounts_processed&#x60;, &#x60;invoices_generated&#x60;, &#x60;credit_memos_generated&#x60;, &#x60;state&#x60;, &#x60;name&#x60;          &lt;/details&gt; | [optional] 
...
namespace Example
{
    public class CreateBillRunExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            var apiInstance = new BillRunsApi(Configuration.Default);
            var billRunCreateRequest = new BillRunCreateRequest(); // BillRunCreateRequest | 
            var fields = new List<string>(); // List<string> | Allows you to specify which fields are returned in the response.          <details>            <summary> Accepted values </summary>              `custom_fields`, `created_by_id`, `updated_by_id`, `created_time`, `id`, `updated_time`, `account_id`, `email`, `post`, `renew`, `batches`, `day_of_month`, `charges_excluded`, `invoice_date`, `email_zero_amount_invoices`, `target_date`, `bill_run_number`, `bill_run_time`, `invoices_sent`, `last_invoice_sent_time`, `accounts_processed`, `invoices_generated`, `credit_memos_generated`, `state`, `name`          </details> (optional) 
            var expand = new List<string>(); // List<string> | Allows you to expand responses by including related object information in a single call. See the [Expand responses](https://www.zuora.com/developer/quickstart-api/tutorial/expand-responses/) section of the Quickstart API Tutorials for detailed instructions. (optional) 
            var filter = new List<string>(); // List<string> | A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \"Retrieve a billing document\" operaiton, you can use the `filter[]` parameter on the related objects such as `filter[]=items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63` (optional) 
            var pageSize = 56;  // int? | The maximum number of results to return in a single page. If the specified `page_size` is less than 1 or greater than 99, Zuora will return a 400 error. (optional) 
            ...
            {
                // Create a bill run
                BillRun result = apiInstance.CreateBillRun(billRunCreateRequest, fields, expand, filter, pageSize, zuoraTrackId, async, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.CreateBillRun: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **billRunCreateRequest** | [**BillRunCreateRequest**](BillRunCreateRequest.md)|  | 
 **fields** | [**List&lt;string&gt;**](string.md)| Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;account_id&#x60;, &#x60;email&#x60;, &#x60;post&#x60;, &#x60;renew&#x60;, &#x60;batches&#x60;, &#x60;day_of_month&#x60;, &#x60;charges_excluded&#x60;, &#x60;invoice_date&#x60;, &#x60;email_zero_amount_invoices&#x60;, &#x60;target_date&#x60;, &#x60;bill_run_number&#x60;, &#x60;bill_run_time&#x60;, &#x60;invoices_sent&#x60;, &#x60;last_invoice_sent_time&#x60;, &#x60;accounts_processed&#x60;, &#x60;invoices_generated&#x60;, &#x60;credit_memos_generated&#x60;, &#x60;state&#x60;, &#x60;name&#x60;          &lt;/details&gt; | [optional] 
 **expand** | [**List&lt;string&gt;**](string.md)| Allows you to expand responses by including related object information in a single call. See the [Expand responses](https://www.zuora.com/developer/quickstart-api/tutorial/expand-responses/) section of the Quickstart API Tutorials for detailed instructions. | [optional] 
 **filter** | [**List&lt;string&gt;**](string.md)| A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \&quot;Retrieve a billing document\&quot; operaiton, you can use the &#x60;filter[]&#x60; parameter on the related objects such as &#x60;filter[]&#x3D;items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63&#x60; | [optional] 
 **pageSize** | **int?**| The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error. | [optional] 
...
> void DeleteBillRun (string billRunId, string zuoraTrackId = null, bool? async = null, string zuoraEntityIds = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class DeleteBillRunExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            {
                // Delete a bill run
                apiInstance.DeleteBillRun(billRunId, zuoraTrackId, async, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.DeleteBillRun: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> BillRun GetBillRun (string billRunId, List<string> fields = null, List<string> expand = null, List<string> filter = null, int? pageSize = null, string zuoraTrackId = null, string zuoraEntityIds = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class GetBillRunExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            {
                // Retrieve a bill run
                BillRun result = apiInstance.GetBillRun(billRunId, fields, expand, filter, pageSize, zuoraTrackId, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.GetBillRun: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> BillRunListResponse GetBillRuns (string cursor = null, List<string> expand = null, List<string> filter = null, List<string> sort = null, int? pageSize = null, List<string> fields = null, string zuoraTrackId = null, string zuoraEntityIds = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class GetBillRunsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            {
                // List bill runs
                BillRunListResponse result = apiInstance.GetBillRuns(cursor, expand, filter, sort, pageSize, fields, zuoraTrackId, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.GetBillRuns: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
[**BillRunListResponse**](BillRunListResponse.md)
...
> BillRun PostBillRun (string billRunId, BillRunPostRequest billRunPostRequest, List<string> fields = null, List<string> expand = null, List<string> filter = null, int? pageSize = null, string zuoraTrackId = null, bool? async = null, string zuoraEntityIds = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class PostBillRunExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            var apiInstance = new BillRunsApi(Configuration.Default);
            var billRunId = billRunId_example;  // string | Identifier for the bill run, either `bill_run_number` or `bill_run_id`
            var billRunPostRequest = new BillRunPostRequest(); // BillRunPostRequest | 
            var fields = new List<string>(); // List<string> | Allows you to specify which fields are returned in the response.          <details>            <summary> Accepted values </summary>              `custom_fields`, `created_by_id`, `updated_by_id`, `created_time`, `id`, `updated_time`, `account_id`, `email`, `post`, `renew`, `batches`, `day_of_month`, `charges_excluded`, `invoice_date`, `email_zero_amount_invoices`, `target_date`, `bill_run_number`, `bill_run_time`, `invoices_sent`, `last_invoice_sent_time`, `accounts_processed`, `invoices_generated`, `credit_memos_generated`, `state`, `name`          </details> (optional) 
            var expand = new List<string>(); // List<string> | Allows you to expand responses by including related object information in a single call. See the [Expand responses](https://www.zuora.com/developer/quickstart-api/tutorial/expand-responses/) section of the Quickstart API Tutorials for detailed instructions. (optional) 
            var filter = new List<string>(); // List<string> | A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \"Retrieve a billing document\" operaiton, you can use the `filter[]` parameter on the related objects such as `filter[]=items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63` (optional) 
            var pageSize = 56;  // int? | The maximum number of results to return in a single page. If the specified `page_size` is less than 1 or greater than 99, Zuora will return a 400 error. (optional) 
            ...
            {
                // Post a bill run
                BillRun result = apiInstance.PostBillRun(billRunId, billRunPostRequest, fields, expand, filter, pageSize, zuoraTrackId, async, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling BillRunsApi.PostBillRun: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
------------- | ------------- | ------------- | -------------
 **billRunId** | **string**| Identifier for the bill run, either &#x60;bill_run_number&#x60; or &#x60;bill_run_id&#x60; | 
 **billRunPostRequest** | [**BillRunPostRequest**](BillRunPostRequest.md)|  | 
 **fields** | [**List&lt;string&gt;**](string.md)| Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;account_id&#x60;, &#x60;email&#x60;, &#x60;post&#x60;, &#x60;renew&#x60;, &#x60;batches&#x60;, &#x60;day_of_month&#x60;, &#x60;charges_excluded&#x60;, &#x60;invoice_date&#x60;, &#x60;email_zero_amount_invoices&#x60;, &#x60;target_date&#x60;, &#x60;bill_run_number&#x60;, &#x60;bill_run_time&#x60;, &#x60;invoices_sent&#x60;, &#x60;last_invoice_sent_time&#x60;, &#x60;accounts_processed&#x60;, &#x60;invoices_generated&#x60;, &#x60;credit_memos_generated&#x60;, &#x60;state&#x60;, &#x60;name&#x60;          &lt;/details&gt; | [optional] 
 **expand** | [**List&lt;string&gt;**](string.md)| Allows you to expand responses by including related object information in a single call. See the [Expand responses](https://www.zuora.com/developer/quickstart-api/tutorial/expand-responses/) section of the Quickstart API Tutorials for detailed instructions. | [optional] 
 **filter** | [**List&lt;string&gt;**](string.md)| A case-sensitive filter on the list. See the [Filter lists](https://www.zuora.com/developer/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorial for detailed instructions.                         Note that the filters on this operation are only applicable to the related objects. For example, when you are calling the \&quot;Retrieve a billing document\&quot; operaiton, you can use the &#x60;filter[]&#x60; parameter on the related objects such as &#x60;filter[]&#x3D;items[subscription_id].EQ:8ad09e208858b5cf0188595208151c63&#x60; | [optional] 
 **pageSize** | **int?**| The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error. | [optional] 
