# Zuora.Api.SubscriptionPlansApi

All URIs are relative to *https://rest.sandbox.na.zuora.com/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetSubscriptionPlan**](SubscriptionPlansApi.md#getsubscriptionplan) | **GET** /subscription_plans/{subscription_plan_id} | Retrieve a subscription plan
[**GetSubscriptionPlans**](SubscriptionPlansApi.md#getsubscriptionplans) | **GET** /subscription_plans | List subscription plans



## GetSubscriptionPlan

> SubscriptionPlan GetSubscriptionPlan (string subscriptionPlanId, List<string> fields = null, List<string> subscriptionFields = null, List<string> subscriptionItemsFields = null, List<string> planFields = null, List<string> productFields = null, List<string> accountFields = null, List<string> priceFields = null, List<string> expand = null, List<string> filter = null, int? pageSize = null, string zuoraTrackId = null, string zuoraEntityIds = null, string idempotencyKey = null, string acceptEncoding = null, string contentEncoding = null)
...
namespace Example
{
    public class GetSubscriptionPlanExample
    {
        public static void Main()
        {
            ...
            var subscriptionPlanId = subscriptionPlanId_example;  // string | Suscription Plan Id
            var fields = new List<string>(); // List<string> | Allows you to specify which fields are returned in the response.          <details>            <summary> Accepted values </summary>              `custom_fields`, `created_by_id`, `updated_by_id`, `created_time`, `id`, `updated_time`, `name`, `plan_id`, `subscription_id`, `product_id`          </details> (optional) 
            ...
            {
                // Retrieve a subscription plan
                SubscriptionPlan result = apiInstance.GetSubscriptionPlan(subscriptionPlanId, fields, subscriptionFields, subscriptionItemsFields, planFields, productFields, accountFields, priceFields, expand, filter, pageSize, zuoraTrackId, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling SubscriptionPlansApi.GetSubscriptionPlan: " + e.Message );
...
------------- | ------------- | ------------- | -------------
 **subscriptionPlanId** | **string**| Suscription Plan Id | 
 **fields** | [**List&lt;string&gt;**](string.md)| Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;name&#x60;, &#x60;plan_id&#x60;, &#x60;subscription_id&#x60;, &#x60;product_id&#x60;          &lt;/details&gt; | [optional] 
...
namespace Example
{
    public class GetSubscriptionPlansExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.sandbox.na.zuora.com/v2";
            ...
            {
                // List subscription plans
                SubscriptionPlanListResponse result = apiInstance.GetSubscriptionPlans(cursor, expand, filter, sort, pageSize, fields, subscriptionFields, subscriptionItemsFields, planFields, productFields, accountFields, priceFields, zuoraTrackId, zuoraEntityIds, idempotencyKey, acceptEncoding, contentEncoding);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling SubscriptionPlansApi.GetSubscriptionPlans: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
[**SubscriptionPlanListResponse**](SubscriptionPlanListResponse.md)
