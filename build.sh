...
${nuget_cmd} install src/Zuora/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Zuora.dll"
...
then
  ...
  echo "[INFO] bin/Zuora.dll was created successfully"
fi
